  ...
  ng.factory('rpc', function($q, $rootScope) {
    ...
    port = {
      postMessage: function(message) {
        return primus.write(['rpc', message]);
      },
      onMessage: null
    };
    $rootScope.$on('rpc', function(event, arg) {
    ...
    return function() {
      ...
      q = $q.defer();
      qc.invoke.apply(qc, args).then(function(res) {
...
},{"q-connection":26}],2:[function(require,module,exports){
